                                ...
                                <form action="{{ route('alumnos.store') }}" method="POST" class="g-form">
                                    ...
                                    <div class="g-form-row">
                                        ...
                                        <select name="nivel_id" id="nivel_id" class="form-control" required>
                                            <option value="1" {{ old('nivel_id') == 1 ? 'selected' : '' }}>Primero
                                            </option>
                                            <option value="2" {{ old('nivel_id') == 2 ? 'selected' : '' }}>Segundo
                                            </option>
                                            <option value="3" {{ old('nivel_id') == 3 ? 'selected' : '' }}>Tercero
                                            </option>
                                            <option value="4" {{ old('nivel_id') == 4 ? 'selected' : '' }}>Cuarto
                                            </option>
                                            <option value="5" {{ old('nivel_id') == 5 ? 'selected' : '' }}>Quinto
                                            </option>
                                            <option value="6" {{ old('nivel_id') == 6 ? 'selected' : '' }}>Sexto
                                            </option>
                                            <option value="7" {{ old('nivel_id') == 7 ? 'selected' : '' }}>Séptimo
                                            </option>
                                            <option value="8" {{ old('nivel_id') == 8 ? 'selected' : '' }}>Octavo
                                            </option>
                                            <option value="9" {{ old('nivel_id') == 9 ? 'selected' : '' }}>Noveno
                                            </option>
                                        </select>
                                    </div>
                                    @error('nivel_id')
                    ...
                    <tbody>
                        @foreach ($alumnos as $alumno)
                            <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-primary d-block mb-2 w-100" data-bs-toggle="modal"
                                data-bs-target="#editar{{ $alumno->id }}">
                                Editar Alumno
                            </button>
